...
namespace CrossPlat.Views.Tables
{
    public class TextCellPage : ContentPage
    {
        public TextCellPage ()
        {
            Product[] products = 
            {
                new Product("Dev Services", "Service", 
                ...
                new Product("Instrumentation", "Product",
                ...
                new Product("Trend Graph", "Product", 
            ...
            foreach (Product product in products)
            {
                ...
                {
                    sectionServices.Add(new TextCell {
                        Text = product.Name,
                ...
                {
                    sectionProducts.Add(new TextCell {
                        Text = product.Name,
                        TextColor = Color.Black,
                        Detail = product.Description,
                        DetailColor = Color.Navy
